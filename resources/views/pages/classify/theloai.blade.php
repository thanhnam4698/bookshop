            ...
            <article>
               <div class="col-md-9">
                  ...
                  <div id="main-content" class="product-content page_commerce">
                     <h1 class="title clearfix"><span>{{ $loaisach->ten_loai }}</span></h1>
                  ...
                  <div class="menu-product ts-product-categories-widget">
                     <div type="button" class="collapsed" data-toggle="collapse" data-target="#category_menu" aria-expanded="false">
                        ...
                        <div class="title-wrapper">
                           <h3 class="hr_title heading-title"><a href="/san-pham/thoi-trang-15148" title="Thời trang">{{ $loaisach->ten_loai }}</a></h3>
                        </div>
                     </div>
                     <div class="block_content navbar-collapse collapse" aria-expanded="false" id="category_menu">
                        <ul class="list-block product-categories tree dynamized" style="display: block;">
                        	@foreach($loaisach->booktopic as $topic)
                           <li>
                           	<a href="{{ route('classify.chude',$topic->id) }}">
                           		<span class="menu-icon">
                           			<i class="fa fa-check"></i>
                           		</span> 
                           		<span class="menu-label">{{ $topic->ten_chu_de }}</span>
                           	</a>
                           </li>
                           @endforeach
                        </ul>
