            ...
            <article>
               <div class="col-md-9">
                  ...
                  <div id="main-content" class="product-content page_commerce">
                     <h1 class="title clearfix"><span>{{ $chude->ten_chu_de }}</span></h1>
                              ...
                              <div class="meta-wrapper right-block">
                                 <div class="pr-0 product-contents">
                                    <h3 class="heading-title product-name">
                                       <a href="/chitiet/{{ $book->slug }}">{{ $book->ten_sach }}</a>
                                    </h3>
                                    <span class="price">
                  ...
                  <div class="menu-product ts-product-categories-widget">
                     <div type="button" class="collapsed" data-toggle="collapse" data-target="#category_menu" aria-expanded="false">
                        ...
                        <div class="title-wrapper">
                           <h3 class="hr_title heading-title"><a href="/san-pham/thoi-trang-15148" title="Thời trang">{{ $chude->ten_chu_de }}</a></h3>
                        </div>
                     </div>
                     <div class="block_content navbar-collapse collapse" aria-expanded="false" id="category_menu">
                        <ul class="list-block product-categories tree dynamized" style="display: block;">
                        	@foreach($chude->bookcontent as $content)
                           <li>
                           	<a href="{{ route('classify.noidung',$content->slug) }}">
                           		<span class="menu-icon">
                           			<i class="fa fa-check"></i>
                           		</span> 
                           		<span class="menu-label">{{ $content->ten_noi_dung }}</span>
                           	</a>
                           </li>
                           @endforeach
                        </ul>
